var config = { 
  ...
  MAX_LATEST_PRICES_TREND: 200, // Limit of latest prices to analyze to determine if price is growing or falling.
  ...
  BOT_SLEEP_DELAY: ((1003)*20*(Math.random()*0.1+1.0)), // bot cycle delay (koef*sec)
  BOT_ON_FAIL_DELAY:((1003)*15*(Math.random()*0.1+1.0)), // bot repeat cycle delay if previous cycle failed
